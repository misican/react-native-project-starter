/*
 * Created: Wednesday, February 26th 2025, 2:14:11 am
 * Author: Melvin Isican (misican@yondu.com)
 * -------------------------------
 * Last Modified: Wednesday, February 26th 2025, 2:15:33 am
 * Modified By: Melvin Isican (misican@yondu.com)
 */

module.exports = {
  // Placeholder name that will be replaced in package.json, index.json, android/, ios/ for a project name.
  placeholderName: 'ReactNativeProjectStarter',
  ...
  titlePlaceholder: 'React Native Project Starter',
